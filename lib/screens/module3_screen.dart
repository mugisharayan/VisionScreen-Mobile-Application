  ...
  final List<Map<String, dynamic>> _steps = [
    {
      ...
      'tip':
          'Bulk mode is ideal for school screenings where you may screen 50+ children in one session.',
    },
    {
      ...
      'tip':
          'Use a descriptive campaign name that includes the location and date — e.g. "Mengo School · March 2026".',
    },
    {
    ...
    },
    {
      ...
      'tip':
          'Campaign stats update automatically whenever a patient is deleted or a new screening is added.',
    },
  ];
