                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                '$completed/${_modules.length} done',
                                style: GoogleFonts.inter(
                                  fontSize: 11,
                                  fontWeight: FontWeight.w700,
                                  color: Colors.white,
...
CustomPainter _moduleIllustration(int index) {
  switch (index) {
    case 0:
      return _Module1Painter();
    case 1:
      return _Module2Painter();
    case 2:
      return _Module3Painter();
    default:
...
class _Module1Painter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final body = Path()
      ..moveTo(cx - 18, cy + 2)
      ..quadraticBezierTo(cx - 10, cy - 4, cx - 2, cy + 2)
      ..lineTo(cx - 2, cy + 18)
      ..lineTo(cx - 18, cy + 18)
      ..close();
    ...
    final clip = RRect.fromRectAndRadius(
      Rect.fromLTWH(cx + 2, cy - 20, 26, 34),
    ...
    for (int i = 0; i < 3; i++) {
      canvas.drawLine(
        Offset(cx + 6, cy - 10 + i * 7.0),
        Offset(cx + 24, cy - 10 + i * 7.0),
        Paint()
          ..color = Colors.white.withValues(alpha: 0.6)
          ..strokeWidth = 1.5
          ..strokeCap = StrokeCap.round,
...
class _Module2Painter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final board = RRect.fromRectAndRadius(
      Rect.fromCenter(center: Offset(cx, cy - 2), width: 38, height: 44),
...
class _Module4Painter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final env = RRect.fromRectAndRadius(
      Rect.fromCenter(center: Offset(cx - 8, cy - 4), width: 36, height: 26),
      const Radius.circular(4),
    );
    ...
    for (int row = 0; row < 2; row++) {
      for (int col = 0; col < 3; col++) {
        canvas.drawCircle(
          Offset(cx + 11 + col * 7.0, cy + 18 + row * 6.0),
          1.5,
          Paint()
            ..color = Colors.white.withValues(alpha: 0.7)
            ..style = PaintingStyle.fill,
