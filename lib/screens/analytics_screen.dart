...
class _AnalyticsScreenState extends State<AnalyticsScreen> {
  ...
  Future<void> _loadStats() async {
    ...
    try {
      ...
      setState(() {
        ...
        _campaigns = results[8] as List<Map<String, dynamic>>;
        _conditionsByAge = results[9] as Map<String, Map<String, int>>;
  ...
  Widget _buildPassRateChart() {
    ...
    final prevRate = passData.length >= 2
        ? passData[passData.length - 2]
        : periodPassRate;
    ...
    if (passData.isNotEmpty) {
      final peakIdx = passData.indexOf(
        passData.reduce((a, b) => a > b ? a : b),
      );
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        '${diff.abs().toStringAsFixed(0)}% vs prev',
                        style: GoogleFonts.inter(
                          fontSize: 10,
                          fontWeight: FontWeight.w700,
                          color: isUp
            ...
            child: Row(
              children: [
                ...
                _legendDot(
                  const Color(0xFFF59E0B),
                  'Refer rate',
                  '${periodReferRate.toStringAsFixed(0)}%',
                ),
                Container(
                  width: 1,
                  height: 28,
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Patient breakdown · $_selectedPeriod',
                      style: GoogleFonts.inter(
                        fontSize: 10,
              ...
              Container(
                ...
                child: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [_demoTabBtn('Age', 0), _demoTabBtn('Gender', 1)],
                ),
              ),
            ],
          ),
          ...
          AnimatedSwitcher(
            ...
            child: _demoTab == 0 ? _buildAgeGroupChart() : _buildGenderChart(),
          ),
        ],
      ),
    );
                      ...
                      children: [
                        ...
                        FractionallySizedBox(
                          widthFactor: maxVal > 0
                              ? (e.$2 / maxVal).clamp(0.0, 1.0)
                              : 0.0,
                          child: Container(
                            height: 10,
                            decoration: BoxDecoration(
                              gradient: LinearGradient(
                                colors: [e.$3.withValues(alpha: 0.6), e.$3],
                              ),
                              borderRadius: BorderRadius.circular(99),
                              boxShadow: [
                                BoxShadow(
                                  color: e.$3.withValues(alpha: 0.4),
                                  blurRadius: 4,
                                ),
                              ],
                            ),
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text(
                    'Snellen chart results — $total eyes assessed',
                    style: GoogleFonts.inter(
                      fontSize: 10,
                      color: const Color(0xFF8FA0B4),
                    ),
  ...
  Widget _buildEyeConditionsSection() {
    ...
    final patientCount = _conditionCounts.isEmpty
        ? 0
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text(
                    'CHW-observed symptoms · $reportCount reports',
                    style: GoogleFonts.inter(
                      fontSize: 10,
                      color: Colors.white.withValues(alpha: 0.4),
                    ),
  ...
  Widget _buildSeverityClassificationSection() {
    ...
    final levels = meta
        .map((m) => (m.$1, _severityCounts[m.$1] ?? 0, m.$2))
        .toList();
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  boxShadow: [
                                    BoxShadow(
                                      color: e.$3.withValues(alpha: 0.5),
                                      blurRadius: 4,
                                    ),
                                  ],
                                ),
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text(
                    '$total total referrals · status breakdown',
                    style: GoogleFonts.inter(
                      fontSize: 10,
                      color: Colors.white.withValues(alpha: 0.4),
                    ),
                  ...
                  children: meta.map((m) {
                    ...
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(14),
                        border: Border.all(color: m.$2.withValues(alpha: 0.3)),
                      ),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Container(
                            ...
                            height: 28,
                            decoration: BoxDecoration(
                              color: m.$2.withValues(alpha: 0.15),
                              borderRadius: BorderRadius.circular(8),
                            ),
  ...
  Widget _buildCampaignOutcomesSection() {
    ...
    final totalScreened = _campaigns.fold(
      0,
      (s, e) => s + ((e['total'] as int?) ?? 0),
    );

    // Sort by pass rate descending for ranking
    final sorted = [..._campaigns]
      ..sort((a, b) {
          ...
          Row(
            children: [
              ...
              Column(
                ...
                children: [
                  Text(
                    'Screening Outcomes by Campaign',
                    style: GoogleFonts.plusJakartaSans(
                      fontSize: 14,
                      fontWeight: FontWeight.w700,
                      color: Colors.white,
                  ...
                  Text(
                    '${_campaigns.length} campaigns · $totalScreened total screened',
                    style: GoogleFonts.inter(
                      fontSize: 10,
                      color: Colors.white.withValues(alpha: 0.4),
                    ),
  ...
  Widget _buildConditionsByAgeSection() {
    ...
    final maxVal = data.fold(0, (m, entry) {
      final rowMax = ageKeys
          .map((k) => entry.value[k] ?? 0)
          .reduce((a, b) => a > b ? a : b);
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text(
                    'CHW-reported symptoms per age group',
                    style: GoogleFonts.inter(
                      fontSize: 10,
                      color: const Color(0xFF8FA0B4),
                    ),
  ...
  Widget _buildVillageBreakdownSection() {
    ...
    final totalPatients = _villages.fold(
      0,
      (s, e) => s + ((e['total'] as int?) ?? 0),
    );
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text(
                    '$totalPatients patients across ${_villages.length} locations',
                    style: GoogleFonts.inter(
                      fontSize: 10,
                      color: const Color(0xFF8FA0B4),
                    ),
  ...
  Widget _buildCampaignProgressSection() {
    ...
    final totalPassed = _campaigns.fold(
      0,
      (s, e) => s + ((e['passed'] as int?) ?? 0),
    );
    final totalReferred = _campaigns.fold(
      0,
      (s, e) => s + ((e['referred'] as int?) ?? 0),
    );
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text(
                    '${_campaigns.length} campaigns · $totalScreened screened',
                    style: GoogleFonts.inter(
                      fontSize: 10,
                      color: const Color(0xFF8FA0B4),
                    ),
              ...
              : Column(
                  children: List.generate(_campaigns.length, (i) {
                    ...
                    final passRate = screened > 0
                        ? (passed / screened * 100).round()
                        : 0;
                    final progress = screened > 0
                        ? (passed / screened).clamp(0.0, 1.0)
                        : 0.0;
  ...
  Widget _buildVulnerablePopulationSection() {
    ...
    final youth = _ageGroups['18-40'] ?? 0;
    final adults = _ageGroups['41-60'] ?? 0;
    ...
    Widget _card(
      ...
      final r = total > 0 ? (count / total).clamp(0.0, 1.0) : 0.0;
      final p = total > 0
          ? '${(count / total * 100).toStringAsFixed(0)}%'
          : '0%';
      return Container(
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text(
                    'Age group breakdown \u00b7 $total patients',
                    style: GoogleFonts.inter(
                      fontSize: 10,
                      color: Colors.white.withValues(alpha: 0.4),
                    ),
          ...
          ...List.generate(insights.length, (i) {
            ...
            return Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: e.accent.withValues(alpha: 0.3),
                  width: 1.2,
                ),
                boxShadow: [
                  BoxShadow(
                    ...
                    Column(
                      children: [
                        Container(
                          ...
                          height: 28,
                          decoration: BoxDecoration(
                            color: e.accent.withValues(alpha: 0.2),
                            borderRadius: BorderRadius.circular(8),
                            border: Border.all(
                              color: e.accent.withValues(alpha: 0.45),
                              width: 1.2,
                            ),
                          ),
                          child: Center(
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: e.accent.withValues(alpha: 0.18),
                              borderRadius: BorderRadius.circular(99),
                              border: Border.all(
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (final pct in [25.0, 50.0, 75.0, 100.0]) {
      ...
      final tp2 = TextPainter(
        text: TextSpan(text: '${pct.toInt()}%', style: lblS),
    ...
    canvas.drawPath(
      Path.from(rPath)
        ..lineTo(xOf(referData.length - 1), size.height)
    ...
    canvas.drawPath(
      Path.from(pPath)
        ..lineTo(xOf(passData.length - 1), size.height)
        ..lineTo(xOf(0), size.height)
        ..close(),
      Paint()
        ..shader = LinearGradient(
    ...
    canvas.drawPath(
      ...
      Paint()
        ...
        ).createShader(Rect.fromLTWH(lp, 0, cW, size.height))
        ..strokeWidth = 3
        ..style = PaintingStyle.stroke
        ..strokeCap = StrokeCap.round
        ..strokeJoin = StrokeJoin.round,
    ...
    for (int i = 0; i < passData.length; i++) {
      ...
      canvas.drawCircle(
        Offset(x, y),
        isPeak ? 6 : 4,
        Paint()..color = isPeak ? _teal3 : _teal,
      );
      canvas.drawCircle(
        Offset(x, y),
        isPeak ? 3 : 2,
      ...
      if (isPeak) {
        ...
        final bW = tp2.width + 14;
        const bH = 20.0;
        final bx = (x - bW / 2).clamp(lp, size.width - bW);
        final by = y - bH - 10;
        canvas.drawRRect(
