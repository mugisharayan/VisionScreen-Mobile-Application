...
final _patients = <_Patient>[
  _Patient(initials: 'AK', avatarGradient: [_teal, _teal2],                                    photoUrl: 'https://images.unsplash.com/photo-1531123897727-8f129e1688ce?w=150&q=80', name: 'Akello Mercy',    age: 34, gender: 'F', village: 'Nakawa, Kampala',  ageGroup: 'adult',   od: '6/6',  os: '6/9',  ou: '6/6',  outcome: 'pass',    date: 'Today · 8m ago',  id: 'PAT-00312'),
  _Patient(initials: 'OJ', avatarGradient: [Color(0xFF7F1D1D), _red],                          photoUrl: 'https://images.unsplash.com/photo-1506277886164-e25aa3f4ef7f?w=150&q=80', name: 'Okello James',    age: 58, gender: 'M', village: 'Bwaise, Kampala',  ageGroup: 'adult',   od: '6/12', os: '6/18', ou: '6/12', outcome: 'refer',   date: 'Today · 22m ago', id: 'PAT-00298'),
  _Patient(initials: 'NA', avatarGradient: [Color(0xFF065F46), _green],                        photoUrl: 'https://images.unsplash.com/photo-1589156280159-27698a70f29e?w=150&q=80', name: 'Nakato Aisha',    age: 27, gender: 'F', village: 'Ntinda, Kampala',  ageGroup: 'adult',   od: '6/9',  os: '6/9',  ou: '6/6',  outcome: 'pass',    date: 'Today · 1hr ago', id: 'PAT-00301'),
  _Patient(initials: 'MW', avatarGradient: [Color(0xFF78350F), _amber],                        photoUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&q=80', name: 'Mugisha Wilson',  age: 45, gender: 'M', village: 'Kireka, Wakiso',   ageGroup: 'adult',   od: '—',    os: '—',    ou: '—',    outcome: 'pending', date: 'Today · Pending', id: 'PAT-00315'),
  _Patient(initials: 'KR', avatarGradient: [_teal, _teal2],                                    photoUrl: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=150&q=80', name: 'Kyomuhendo Rose', age: 19, gender: 'F', village: 'Rubaga, Kampala',  ageGroup: 'adult',   od: '6/6',  os: '6/6',  ou: '6/6',  outcome: 'pass',    date: '26 Mar',          id: 'PAT-00289'),
  _Patient(initials: 'BS', avatarGradient: [Color(0xFF1E3A5F), _blue],                         photoUrl: 'https://images.unsplash.com/photo-1552058544-f2b08422138a?w=150&q=80', name: 'Byaruhanga Sam',  age: 62, gender: 'M', village: 'Kawempe, Kampala', ageGroup: 'elderly', od: '6/24', os: '6/36', ou: '6/24', outcome: 'refer',   date: '25 Mar',          id: 'PAT-00276'),
  _Patient(initials: 'TK', avatarGradient: [Color(0xFF1E3A5F), _blue],                         photoUrl: 'https://images.unsplash.com/photo-1503454537195-1dcabb73ffb9?w=150&q=80', name: 'Tendo Kevin',     age: 9,  gender: 'M', village: 'Nansana, Wakiso',  ageGroup: 'child',   od: '6/9',  os: '6/9',  ou: '6/6',  outcome: 'pass',    date: '24 Mar',          id: 'PAT-00261'),
  _Patient(initials: 'AN', avatarGradient: [Color(0xFF4C1D95), Color(0xFF7C3AED)],             photoUrl: 'https://images.unsplash.com/photo-1516627145497-ae6968895b74?w=150&q=80', name: 'Apio Norah',      age: 8,  gender: 'F', village: 'Kira, Wakiso',     ageGroup: 'child',   od: '6/18', os: '6/12', ou: '6/12', outcome: 'refer',   date: '23 Mar',          id: 'PAT-00254'),
];
          ...
          Expanded(
            child: list.isEmpty
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (_, i) {
                      if (i == 0) return _sectionLabel('Today · ${DateTime.now().day} Mar ${DateTime.now().year}');
                      return Padding(
          ...
          children: [
                    ...
                    children: [
                      Text('Patients',
                          style: GoogleFonts.plusJakartaSans(
                              ...
                              color: Colors.white)),
                      Text('247 registered · Wakiso & Kampala',
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    prefixIcon: Icon(Icons.search_rounded,
                        size: 18, color: _teal3.withOpacity(0.5)),
            ...
            SizedBox(
              ...
              child: ListView(
                ...
                padding: const EdgeInsets.symmetric(horizontal: 20),
                children: ['All', 'Pass', 'Refer', 'Pending', 'Child', 'Adult', 'Elderly']
                    .map((f) => _filterChip(f))
                    .toList(),
              ),
            ),
  ...
  Widget _filterChip(String label) {
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: active ? _teal.withOpacity(0.25) : Colors.white.withOpacity(0.06),
                          ...
                          Row(
                            children: [
                              const Icon(Icons.person_outline_rounded,
                                  size: 11, color: Color(0xFF8FA0B4)),
                          ...
                          if (p.outcome != 'pending')
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                    color: _amber.withOpacity(0.2), width: 1),
                              ),
                              child: Row(
                ...
                child: Row(
                  children: [
                    const Icon(Icons.badge_outlined,
                        size: 12, color: Color(0xFF8FA0B4)),
                    const SizedBox(width: 5),
                    Text(p.id,
                        style: GoogleFonts.inter(
                            fontSize: 11,
      ...
      child: Column(
        ...
        children: [
          const Icon(Icons.search_off_rounded,
              size: 48, color: Color(0xFFDDE4EC)),
          const SizedBox(height: 12),
          ...
          Text('Try a different name, ID or village,\nor clear the filter.',
