      ...
      child: SafeArea(
        ...
        Row(children: [
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text('MODULE 2', style: GoogleFonts.inter(fontSize: 9, fontWeight: FontWeight.w700, color: Colors.white.withValues(alpha: 0.6), letterSpacing: 1.8)),
            Text('Vision Testing', style: GoogleFonts.plusJakartaSans(fontSize: 17, fontWeight: FontWeight.w800, color: Colors.white)),
          ])),
          Container(
            ...
            onTap: () {
              if (isLast) {
                ...
                ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                  content: Text('Module 2 completed! 🎉', style: GoogleFonts.inter(fontSize: 12, color: Colors.white)),
