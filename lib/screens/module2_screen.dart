  ...
  final List<Map<String, dynamic>> _steps = [
    {
      ...
      'tip':
          'Demonstrate the E direction yourself first — show the patient how to point left, right, up or down before starting.',
    },
    {
      ...
      'tip':
          'If the light check fails, move to a brighter room or turn on all available lights before proceeding.',
    },
    {
      ...
      'tip':
          'Make sure the patient covers their eye completely with their palm — not just closing it. Peeking gives inaccurate results.',
    },
    {
      ...
      'tip':
          'The algorithm is self-terminating — it stops automatically when the threshold is found. Do not rush the patient.',
    },
    {
      ...
      'tip':
          'Always explain the result to the patient in simple terms — "Your right eye sees well, but your left eye needs a check-up at the clinic."',
    },
  ];
      ...
      child: Column(
        ...
        children: [
          ...
          ClipRRect(
            ...
            child: Module2Illustration(color: color),
          ),
