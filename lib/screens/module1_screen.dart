...
class _Module1ScreenState extends State<Module1Screen> {
  ...
  final List<Map<String, dynamic>> _steps = [
    {
      ...
      'tip':
          'Individual screening is for detailed one-on-one assessments. Bulk mode is for schools, health camps and community outreach.',
    },
    {
      ...
      'body':
          ...
          'Tap "Register patient" to save and proceed to the eye test.',
      'tip':
          'For BULK mode, only Name, Age, Gender, Phone and Eye Conditions are required — registration takes under 15 seconds per patient.',
    },
    {
    ...
    },
    {
      ...
      'tip':
          'Conditions like Diabetes and Hypertension are important risk factors for vision problems — always ask about them.',
    },
    {
      ...
      'tip':
          'Pull down to refresh the patients list after adding new screenings.',
    },
  ];
  ...
  Widget build(BuildContext context) {
    ...
    // Brand teal across all steps — modules already differ by icon/title/illustration.
